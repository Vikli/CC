...
class CustomListViewSearch extends ArrayAdapter<String> {
    ...
    public CustomListViewSearch(Activity context, String[] profilename, String[] email, String[] barcode) {
        super(context, R.layout.layoutsearch, profilename);
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (r == null) {
            ...
            r = layoutInflater.inflate(R.layout.layoutsearch, null, true);
