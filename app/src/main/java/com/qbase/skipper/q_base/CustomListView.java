...
class CustomListView extends ArrayAdapter<String> {
    ...
    public CustomListView(Activity context, String[] profilename, String[] email, String[] barcode, String[] status) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        viewHolder.tvw4.setText(status[position]);
    ...
    class ViewHolder {
        ...
        ViewHolder(View v) {
            ...
            tvw3 = v.findViewById(R.id.barcode);
            tvw4 = v.findViewById(R.id.status);
        }
